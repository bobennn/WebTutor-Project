...
<form action="course_form_edit_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-7">
      <input type="text" name="c_name" required class="form-control" maxlength="80" value="<?php echo $row['c_name']; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="number" name="c_price" required class="form-control"  value="<?php echo $row['c_price']; ?>">
    </div>
  </div>
